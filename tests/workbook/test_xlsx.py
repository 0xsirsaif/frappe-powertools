...
class TestIterValidatedRowsXLSX:
    ...
    def test_missing_required_fields(self, customer_model, missing_field_xlsx_workbook, default_xlsx_config):
    ...
    def test_stop_on_first_error(self, customer_model, mixed_validity_xlsx_workbook, default_xlsx_config):
